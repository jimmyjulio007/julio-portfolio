  ...
  return (
    <div id='contact' className='flex flex-col pt-10 gap-10 md:gap-20 justify-center px-4 lg:px-10 xl:px-40 pb-16 md:pb-36 items-start'>
      <div className='flex flex-col w-full border-b border-[#A8A8A8] pb-10 md:pb-20 relative'>
        <p className='text-2xl md:text-[72px] font-syne font-bold'>Contact Me</p>
        <Image src="/blur.svg" alt="blur" className="overflow-hidden animate-pulse absolute -top-36 -left-40" width={517} height={273}/>
        <span className='font-rubik text-sm md:text-[18px] text-[#A8A8A8] font-semibold'>For Any Project Knock Me</span>
      </div>
      <div className='flex max-sm:flex-col gap-5 justify-between w-full'>
        <p className='text-2xl md:text-[64px] max-w-[200px] md:max-w-[450px] font-syne font-bold uppercase'>Get in touch with me!</p>
        <div className='flex flex-col gap-10 md:w-2/6'>
          <form className='flex flex-col gap-6'>
            <div className="relative">
              ...
              <label htmlFor="email" className=" absolute left-0 -top-5 uppercase font-bold font-syne text-white text-[24px] transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-white peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-orange-500 peer-focus:text-sm">Email address</label>
            </div>
            <div className="relative">
              ...
              <label htmlFor="subject" className="absolute left-0 -top-5 uppercase font-bold font-syne text-white text-[24px] transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-white peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-orange-500 peer-focus:text-sm">Subject</label>
            </div>
            <div className="relative">
            ...
            <button id='send' type='submit' className='btn-send flex-initial w-fit'>Send <Mail /></button>
          </form>
        </div>
      </div>
